...
//        text = if(isEnabled) "Submit" else "Isi Dulu"
    ...
    private fun init() {
        ...
        enabledBackground = ContextCompat.getDrawable(context, R.drawable.bg_buttom) as Drawable
        disabledBackground = ContextCompat.getDrawable(context, R.drawable.bg_buttom_disable) as Drawable
    }
}